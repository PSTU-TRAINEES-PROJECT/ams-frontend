...
import { aboutData1, aboutData2, aboutData3 } from "../../../utils/helper/dummy-data/aboutData"
...
export default function AboutPage() {
    return (
                    ...
                    {aboutData1.map((item, index) => (
                        <div key={index} className="flex flex-col md:flex-row md:items-center md:mt-40">
                            ...
                            <div className="md:absolute md:right-24 md:w-1/2 mb-4 md:mb-0">
                                <Image src={item.img} alt="About first image section" width={100} height={100} className="w-full h-auto object-cover" />
                            </div>
                            {/* Text container */}
                ...
                <div className="relative flex-grow px-4 md:px-12 py-8 md:py-12  md:mt-96">
                    {aboutData2.map((item, index) => (
                        <div key={index} className="flex flex-col md:flex-row md:items-center">
                            ...
                            {/* Image container */}
                            <div className="absolute mt-[-10px] md:left-24 md:w-1/2 w-[345px]">
                                <Image src={item.img} alt="About second image section" width={100} height={100} className="w-full h-auto object-cover rounded-lg" />
                            </div>
                        </div>
                    ))}
                </div>
      ...
      <div className="md:mt-[22rem] mt-[24rem]">
      <Footer  />
      </div>
        </>
    );
