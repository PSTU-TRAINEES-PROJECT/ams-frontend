  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white">
      <div className="w-3/4 flex items-center justify-between p-4">
        <div className="text-blue-500  text-4xl font-bold">LOGO</div>
        <div>
      ...
      <div className="w-full max-w-md p-8 space-y-6 bg-white shadow-lg rounded-md">
        ...
        <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex justify-between text-center">
            <a
              href="#"
              className="hover:underline text-xl text-left text-gray-600"
            >
              <input type="radio" />
            ...
            <p>
              <a
                href="#"
                className="text-right text-xl text-blue-600 font-bold hover:underline"
              >
                Forget Password
              </a>
            </p>
        ...
        >
          <Image
            ...
            width={500}
            height={200}
            className=" font-xl inline w-5 h-5 mr-2"
          />
          Login with Google
        </button>
      </div>
