  ...
  return (
    <header className="flex flex-row border-b shadow-md p-4 md:px-[90px] ">
      ...
      <div className="flex items-center justify-between w-full">
        <h1 className="text-4xl sm:text-4xl font-bold lg:ml-10 text-blue-500">
          AmS
        </h1>
        ...
        <div className="absolute top-16 justify-between right-4 bg-white shadow-lg rounded-lg p-6 z-10 w-55 md:hidden">
          ...
          <div className="flex flex-row justify-between space-x-4 mt-4">
            <Link href="/signup" onClick={() => setIsMenuOpen(false)}>
              <button className="text-base px-4 py-2 border font-semibold text-blue-500 rounded-md ">
                Signup
              </button>
            </Link>
     ...
     {/* No Chnage */}
      ...
      <div className="hidden md:flex space-x-2 md:mr-0 lg:mr-6  ">
        <Link href="/signup">
          <button className="text-2xl px-4 py-2 border font-semibold  text-blue-500 rounded-md">
            Signup
          </button>
        </Link>
        <Link href="/login">
